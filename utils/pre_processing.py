...
def formatted_data(x, t, e, idx, imputation_values):
    ...
    print("Proportion missing before", np.sum(np.isnan(covariates)))
    ...
    print("Proportion missing after ", np.sum(np.isnan(impute_covariates)))
